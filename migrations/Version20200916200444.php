 ...
 */
final class Version20200916200444 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE admin (id INT NOT NULL, username VARCHAR(100) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, last_login TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, permission SMALLINT NOT NULL, join_date DATE NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
